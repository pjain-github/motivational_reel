...
#     st.session_state.background_music = "samples/sample_background_music.mp3"
...
#         else:
#             st.session_state.audio_path = audio_path  # Save audio path
#             st.session_state.wps = round(wps, 1)  # Save words per second
#             st.session_state.subtitle_video_path = None  # Reset subtitle video path
...
#     if uploaded_music:
#         # Save the uploaded file path in session state
#         music_path = f"temp_music.{uploaded_music.name.split('.')[-1]}"
#         with open(music_path, "wb") as f:
#             f.write(uploaded_music.read())

#         st.session_state.background_music = music_path
